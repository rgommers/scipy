...
cdef double _clough_tocher_2d_single_double(qhull.DelaunayInfo_t *d,
    ...
    """
    cdef double          c3000, c0300, c0030, c0003,          c2100, c2010, c2001, c0210, c0201, c0021,          c1200, c1020, c1002, c0120, c0102, c0012,          c1101, c1011, c0111
    cdef double          f1, f2, f3, df12, df13, df21, df23, df31, df32
    cdef double          g1, g2, g3
    cdef double          e12x, e12y, e23x, e23y, e31x, e31y,          e14x, e14y, e24x, e24y, e34x, e34y
    cdef double w
    cdef double minval
...
cdef double complex _clough_tocher_2d_single_complex(qhull.DelaunayInfo_t *d,
    ...
    """
    cdef double complex          c3000, c0300, c0030, c0003,          c2100, c2010, c2001, c0210, c0201, c0021,          c1200, c1020, c1002, c0120, c0102, c0012,          c1101, c1011, c0111
    cdef double complex          f1, f2, f3, df12, df13, df21, df23, df31, df32
    cdef double          g1, g2, g3
    cdef double          e12x, e12y, e23x, e23y, e31x, e31y,          e14x, e14y, e24x, e24y, e34x, e34y
...
class CloughTocher2DInterpolator(NDInterpolatorBase):
    ...
    def _evaluate_double(self, np.ndarray[np.double_t, ndim=2] xi):
        ...
        cdef double df[2*NPY_MAXDIMS+2]
        cdef double w
        cdef double fill_value
        cdef int i, j, k, m, ndim, isimplex, inside, start, nvalues
        cdef qhull.DelaunayInfo_t info
    ...
    def _evaluate_complex(self, np.ndarray[np.double_t, ndim=2] xi):
        ...
        cdef double complex df[2*NPY_MAXDIMS+2]
        cdef double complex w
        cdef double complex fill_value
        cdef int i, j, k, m, ndim, isimplex, inside, start, nvalues
        cdef qhull.DelaunayInfo_t info
