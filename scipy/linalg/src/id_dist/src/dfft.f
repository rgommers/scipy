...
C 
  ...
  117 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      ...
      IW1 = N+N+1
      IW2 = IW1+N+N
      CALL ZFFTB1 (N,C,WSAVE,WSAVE(IW1), INTEGER WSAVE(IW2))
      RETURN
      END
  ...
  117 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      ...
      IW1 = N+N+1
      IW2 = IW1+N+N
      CALL ZFFTF1 (N,C,WSAVE,WSAVE(IW1), INTEGER WSAVE(IW2))
      RETURN
      END
  ...
  110 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      ...
      IW1 = N+N+1
      IW2 = IW1+N+N
      CALL ZFFTI1 (N,WSAVE(IW1), INTEGER WSAVE(IW2))
      RETURN
      END
...
C
  ...
  105 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION       WSAVE(*)
      IF (N .EQ. 1) RETURN
      CALL DZFFT1 (N,WSAVE(2*N+1), INTEGER WSAVE(3*N+1))
      RETURN
      END
...
C
  ...
  117 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION       R(*)       ,WSAVE(*)
      IF (N .EQ. 1) RETURN
      CALL DFFTB1 (N,R,WSAVE,WSAVE(N+1), INTEGER WSAVE(2*N+1))
      RETURN
      END
  ...
  112 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION       R(*)       ,WSAVE(*)
      IF (N .EQ. 1) RETURN
      CALL DFFTF1 (N,R,WSAVE,WSAVE(N+1), INTEGER WSAVE(2*N+1))
      RETURN
      END
  ...
  110 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION       WSAVE(*)
      IF (N .EQ. 1) RETURN
      CALL DFFTI1 (N,WSAVE(N+1), INTEGER WSAVE(2*N+1))
      RETURN
      END
  ...
  107 CONTINUE
	...
	IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      ...
      IW2 = IW1+NP1
      IW3 = IW2+NP1
      CALL DSINT1(N,X,WSAVE,WSAVE(IW1),WSAVE(IW2), INTEGER WSAVE(IW3))
      RETURN
      END
