...
- :py:func:`~scipy.special.bdtrik`::
        ...
        float bdtrik_f(float, float, float)

- :py:func:`~scipy.special.bdtrin`::

        double bdtrin(double, double, double)
        float bdtrin_f(float, float, float)
...
- :py:func:`~scipy.special.nbdtrik`::
        ...
        float nbdtrik_f(float, float, float)

- :py:func:`~scipy.special.nbdtrin`::

        double nbdtrin(double, double, double)
        float nbdtrin_f(float, float, float)
...
cpdef float bdtrik_f(float x0, float x1, float x2) noexcept nogil:
    """See the documentation for scipy.special.bdtrik (float specialization)"""
...
cpdef float nbdtrin_f(float x0, float x1, float x2) noexcept nogil:
    """See the documentation for scipy.special.nbdtrin (float specialization)"""
...
cpdef float nbdtrik_f(float x0, float x1, float x2) noexcept nogil:
    """See the documentation for scipy.special.nbdtrik (float specialization)"""
...
cpdef float bdtrin_f(float x0, float x1, float x2) noexcept nogil:
    """See the documentation for scipy.special.bdtrin (float specialization)"""
